...
/// বাংলাদেশ ইসলামী ছাত্র মজলিস — বার্ষিক / ষান্মাসিক / দ্বি-মাসিক পরিকল্পনা বই
class StudentPeriodPlanBookScreen extends StatefulWidget {
  const StudentPeriodPlanBookScreen({super.key});

  @override
  State<StudentPeriodPlanBookScreen> createState() => _StudentPeriodPlanBookScreenState();
}

class _StudentPeriodPlanBookScreenState extends State<StudentPeriodPlanBookScreen> {
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: const Text(
              'বার্ষিক / ষান্মাসিক / দ্বি-মাসিক পরিকল্পনা বই',
              style: TextStyle(color: purpleColor, fontSize: 15, fontWeight: FontWeight.bold),
            ),
            actions: [
              IconButton(
                icon: Icon(
          ...
          body: AmbientBackgroundWidget(
            primaryAccent: purpleColor,
            child: SingleChildScrollView(
              padding: const EdgeInsets.all(20),
              child: Column(
                children: [
                  _buildBookSummaryCard(cardBg, borderColor, textLight, purpleColor),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.assignment_turned_in_rounded, color: accentColor, size: 30),
          ),
