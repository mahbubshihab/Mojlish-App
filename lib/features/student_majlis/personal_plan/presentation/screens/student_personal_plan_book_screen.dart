...
/// বাংলাদেশ ইসলামী ছাত্র মজলিস — ব্যক্তিগত মাসিক পরিকল্পনা বই
class StudentPersonalPlanBookScreen extends StatefulWidget {
  const StudentPersonalPlanBookScreen({super.key});

  @override
  State<StudentPersonalPlanBookScreen> createState() => _StudentPersonalPlanBookScreenState();
}

class _StudentPersonalPlanBookScreenState extends State<StudentPersonalPlanBookScreen> {
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          ...
          body: AmbientBackgroundWidget(
            primaryAccent: tealColor,
            child: SingleChildScrollView(
              padding: const EdgeInsets.all(20),
              child: Column(
                children: [
                  _buildBookSummaryCard(cardBg, borderColor, textLight, tealColor),
                  const SizedBox(height: 16),
                  _buildYearHeader(cardBg, borderColor, textLight, tealColor),
                  const SizedBox(height: 20),
                  _buildMonthGrid(cardBg, borderColor, textLight, textMuted, tealColor),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.person_outline_rounded, color: accentColor, size: 30),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'ব্যক্তিগত মাসিক পরিকল্পনা — বাংলাদেশ ইসলামী ছাত্র মজলিস',
