...
/// বাংলাদেশ ইসলামী ছাত্র মজলিস — বার্ষিক / ষান্মাসিক / দ্বি-মাসিক রিপোর্ট বই
class StudentPeriodReportBookScreen extends StatefulWidget {
  const StudentPeriodReportBookScreen({super.key});

  @override
  State<StudentPeriodReportBookScreen> createState() => _StudentPeriodReportBookScreenState();
}

class _StudentPeriodReportBookScreenState extends State<StudentPeriodReportBookScreen> {
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: const Text(
              'বার্ষিক / ষান্মাসিক / দ্বি-মাসিক রিপোর্ট বই',
          ...
          body: AmbientBackgroundWidget(
            primaryAccent: blueColor,
            child: SingleChildScrollView(
              padding: const EdgeInsets.all(20),
              child: Column(
                children: [
                  _buildBookSummaryCard(cardBg, borderColor, textLight, blueColor),
                  const SizedBox(height: 16),
                  _buildYearHeader(cardBg, borderColor, textLight, blueColor),
                  const SizedBox(height: 20),
                  _buildMonthGrid(cardBg, borderColor, textLight, textMuted, blueColor),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.assessment_rounded, color: accentColor, size: 30),
          ),
