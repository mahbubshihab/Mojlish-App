  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'জোনাল রিপোর্ট বই',
          style: TextStyle(color: _accentPurple, fontSize: 18, fontWeight: FontWeight.bold),
        ),
      ),
      body: Stack(
        children: [
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _accentPurple.withValues(alpha: 0.4), width: 2),
            ),
            child: const Icon(Icons.map, color: _accentPurple, size: 26),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(color: _accentPurple, fontSize: 13, fontWeight: FontWeight.bold),
                ),
              ],
            ),
          ),
