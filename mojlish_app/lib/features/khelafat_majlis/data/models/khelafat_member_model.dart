/// Khelafat Majlis Primary Member Application Model
class KhelafatMemberModel {
  final String id;
  final String name;
  ...
  factory KhelafatMemberModel.fromJson(Map<String, dynamic> json) => KhelafatMemberModel(
        id: json['id'] ?? '',
        name: json['name'] ?? '',
