...
class PersonalReportTableScreen extends StatefulWidget {
  final int year;
  final int month;
  final MajlisType majlisType;

  const PersonalReportTableScreen({
    super.key,
    required this.year,
    required this.month,
  ...
  @override
  State<PersonalReportTableScreen> createState() => _PersonalReportTableScreenState();
}

class _PersonalReportTableScreenState extends State<PersonalReportTableScreen>
