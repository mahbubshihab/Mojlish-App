...
import 'khelafat_porichiti_screen.dart';
import 'khelafat_karjopronali_screen.dart';
import 'khelafat_sodosso_form_screen.dart';
import 'khelafat_shakha_plan_screen.dart';

/// খেলাফত মজলিস — মূল ফিচার হাব ও ড্যাশবোর্ড স্ক্রিন
                ...
                GridView.count(
                  ...
                  children: [
                    _buildHubCard(
                      ...
                      cardBg: cardBg,
                      textColor: textColor,
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KhelafatPorichitiScreen())),
                    ),
                    _buildHubCard(
                      context,
                      ...
                      cardBg: cardBg,
                      textColor: textColor,
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KhelafatKarjopronaliScreen())),
                    ),
                    _buildHubCard(
                      context,
                      ...
                      cardBg: cardBg,
                      textColor: textColor,
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KhelafatSodossoFormScreen())),
                    ),
                    _buildHubCard(
                      context,
                      ...
                      cardBg: cardBg,
                      textColor: textColor,
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const KhelafatShakhaPlanScreen())),
                    ),
                    _buildHubCard(
                      context,
