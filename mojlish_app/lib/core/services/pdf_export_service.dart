          ...
          return [
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      bWidget('ব্যবহারকারীর নাম: $userName', fontSize: 10, fontWeight: pw.FontWeight.bold, color: PdfColors.black),
                      pw.SizedBox(height: 2),
                      bWidget('মজলিস: $majlisName', fontSize: 9.5, color: PdfColors.grey800),
                    ],
                  ),
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.end,
                    children: [
                      bWidget('সময়কাল: $period', fontSize: 9.5, color: PdfColors.grey800),
                      pw.SizedBox(height: 2),
                      bWidget('তারিখ: ${DateTime.now().toString().split(' ')[0]}', fontSize: 9.5, color: PdfColors.grey800),
                    ],
                  ),
                ],
              ),
                ...
                children: dataFields.entries.map((entry) {
                  return pw.Container(
                    ...
                    child: pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        bWidget(entry.key, fontSize: 9.5, color: PdfColors.grey800),
                        bWidget('${entry.value}', fontSize: 9.5, fontWeight: pw.FontWeight.bold, color: PdfColors.black),
                      ],
                    ),
                  );
                }).toList(),
            ...
            if (comments != null && comments.isNotEmpty) ...[
              ...
              pw.Container(
                ...
                child: bWidget(comments, fontSize: 9.5, color: PdfColors.grey800),
              ),
            ],
          ];
        },
                ...
                child: headerMetadata != null && headerMetadata.isNotEmpty
                    ...
                    : pw.Row(
                        ...
                        children: [
                          ...
                          bWidget('মাস : ${monthData.monthName}   সন : ${monthData.year}', fontSize: 8.5, fontWeight: pw.FontWeight.bold, color: PdfColors.black),
                        ],
                      ),
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 8),
                    bWidget('নাম : ${name.isNotEmpty ? name : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('পিতার নাম : ${fatherName.isNotEmpty ? fatherName : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    pw.Row(
                      children: [
                        pw.Expanded(child: bWidget('শিক্ষা প্রতিষ্ঠান : ${eduInstitution.isNotEmpty ? eduInstitution : ".................................................."}', fontSize: 10)),
                        bWidget('রক্তের গ্রুপ : ${bloodGroup.isNotEmpty ? bloodGroup : "...................."}', fontSize: 10),
                      ],
                    ),
                    pw.SizedBox(height: 6),
                    pw.Row(
                      children: [
                        pw.Expanded(child: bWidget('শ্রেণি : ${studentClass.isNotEmpty ? studentClass : "...................."}', fontSize: 10)),
                        pw.Expanded(child: bWidget('বিভাগ : ${department.isNotEmpty ? department : "...................."}', fontSize: 10)),
                        bWidget('ক্রমিক নং : ${rollNo.isNotEmpty ? rollNo : "...................."}', fontSize: 10),
                      ],
                    ),
                    pw.SizedBox(height: 6),
                    bWidget('বর্তমান ঠিকানা : ${presentAddress.isNotEmpty ? presentAddress : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('মোবাইল : ${mobile.isNotEmpty ? mobile : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    pw.Row(
                      children: [
                        pw.Expanded(child: bWidget('স্থায়ী ঠিকানা : গ্রাম : ${village.isNotEmpty ? village : "........................................"}', fontSize: 10)),
                        bWidget('ডাকঘর : ${postOffice.isNotEmpty ? postOffice : "........................................"}', fontSize: 10),
                      ],
                    ),
                    pw.SizedBox(height: 6),
                    pw.Row(
                      children: [
                        pw.Expanded(child: bWidget('থানা/উপজেলা : ${thana.isNotEmpty ? thana : "........................................"}', fontSize: 10)),
                        bWidget('জেলা : ${district.isNotEmpty ? district : "........................................"}', fontSize: 10),
                      ],
                    ),
                    pw.SizedBox(height: 16),
                    pw.Row(
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    bWidget('নাম : ${name.isNotEmpty ? name : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('পিতা : ${fatherName.isNotEmpty ? fatherName : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('জাতীয় পরিচয়পত্র নং : ${nidNumber.isNotEmpty ? nidNumber : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('ঠিকানা : গ্রাম : ${village.isNotEmpty ? village : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    pw.Row(
                      children: [
                        pw.Expanded(child: bWidget('ইউনিয়ন : ${unionName.isNotEmpty ? unionName : "........................................"}', fontSize: 10)),
                        pw.Expanded(child: bWidget('থানা ও উপজেলা : ${thanaUpazila.isNotEmpty ? thanaUpazila : "........................................"}', fontSize: 10)),
                      ],
                    ),
                    pw.SizedBox(height: 6),
                    bWidget('জেলা : ${district.isNotEmpty ? district : "...................................................................................................................."}', fontSize: 10),
                    ...
                    bWidget('মোবাইল : ${mobile.isNotEmpty ? mobile : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 6),
                    bWidget('ইমেইল : ${email.isNotEmpty ? email : "...................................................................................................................."}', fontSize: 10),
                    pw.SizedBox(height: 12),
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        bWidget('যোগদানের তারিখ : ${joinDate.isNotEmpty ? joinDate : "....................."}', fontSize: 9.5),
                        bWidget('স্বাক্ষর : .....................', fontSize: 9.5),
                      ],
                    ),
                  ],
                ),
